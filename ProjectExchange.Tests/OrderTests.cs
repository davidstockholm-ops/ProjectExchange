...
public class OrderTests
{
    ...
    public void Constructor_PriceBelowZero_ThrowsArgumentOutOfRangeException()
    {
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            new Order(Guid.NewGuid(), Guid.NewGuid().ToString(), "outcome-x", OrderType.Bid, -0.01m, 10m));
    }
    ...
    {
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            new Order(Guid.NewGuid(), Guid.NewGuid().ToString(), "outcome-x", OrderType.Bid, 1.01m, 10m));
    }
    ...
    {
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            new Order(Guid.NewGuid(), Guid.NewGuid().ToString(), "outcome-x", OrderType.Bid, 0.50m, 0m));
    }
    ...
    {
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            new Order(Guid.NewGuid(), Guid.NewGuid().ToString(), "outcome-x", OrderType.Bid, 0.50m, -10m));
    }
    ...
    public void Constructor_OutcomeIdNull_ThrowsArgumentException()
    {
        Assert.Throws<ArgumentException>(() =>
            new Order(Guid.NewGuid(), Guid.NewGuid().ToString(), null!, OrderType.Bid, 0.50m, 10m));
    }
    ...
    {
        Assert.Throws<ArgumentException>(() =>
            new Order(Guid.NewGuid(), Guid.NewGuid().ToString(), "   ", OrderType.Bid, 0.50m, 10m));
    }

    [Fact]
    public void Constructor_ValidArgs_Succeeds()
    {
        var order = new Order(Guid.NewGuid(), Guid.NewGuid().ToString(), "outcome-x", OrderType.Ask, 0.50m, 10m);
